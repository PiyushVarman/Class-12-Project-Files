...
and MySQL is created. Using the DDL command CREATE TABLE, a student table structure is
created. Using DML commands INSERT, SELECT, UPDATE the operations are performed to
