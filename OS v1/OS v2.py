...
root.title("AaloOs")
tbar= Canvas(root,width='2500',height = "50",highlightthickness=0)
tbar.place(y=720)
mbar=Canvas(root,width='2500',height = "30",highlightthickness=0)
mbar.place(y=0)
...
def missioncontrol(): #Use Control-S to activate your colour option
   ...
   db.pack()
   bb=Button(wlc,text='Buttons',font=(100),command=buttons)
   bb.pack()
